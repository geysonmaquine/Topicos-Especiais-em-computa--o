...
:::{layout="[[1,1], [1]]" style="text-align:center;font-size:25px;"}
### Portas Lógicas
![](img/digital_quantum.jpg){width="850px"}

### Algoritmo Quântico de Otimização Aproximada (QAOA)
![](img/quantum_annealer.png){width="800px"}


Fonte: Fingerhuth, Babej e Wittek (2018).^[Fingerhuth, M.; Babej, T.; Wittek, P. Open Source Software in Quantum Computing. PLOS ONE 2018, 13 (12), e0208561. <https://doi.org/10.1371/journal.pone.0208561>.]
:::
